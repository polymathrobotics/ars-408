...
namespace FHAC
{
      ...
      const rclcpp_lifecycle::State &)
  {
    ...
    do
    {
      ...
      if (node->get_parameter(radar_name + ".link_name", parameter))
      {
        ...
        initializeConfig<uint32_t>(radar_name, std::string("filtercfg_min_nofobj"), 0, radar_filter_configs_[topic_ind].filtercfg_min_nofobj);
        initializeConfig<uint32_t>(radar_name, std::string("filtercfg_max_nofobj"), 20, radar_filter_configs_[topic_ind].filtercfg_max_nofobj);

        // Initialize Distance Filters
        initializeConfig<float>(radar_name, std::string("filtercfg_min_distance"), 0.0, radar_filter_configs_[topic_ind].filtercfg_min_distance);
        initializeConfig<float>(radar_name, std::string("filtercfg_max_distance"), 409.0, radar_filter_configs_[topic_ind].filtercfg_max_distance);

        // Initialize Azimuth Filters
        initializeConfig<float>(radar_name, std::string("filtercfg_min_azimuth"), 0.0, radar_filter_configs_[topic_ind].filtercfg_min_azimuth);
        initializeConfig<float>(radar_name, std::string("filtercfg_max_azimuth"), 100.0, radar_filter_configs_[topic_ind].filtercfg_max_azimuth);

        // Initialize Oncoming Velocity Filters
        initializeConfig<float>(radar_name, std::string("filtercfg_min_vreloncome"), 0.0, radar_filter_configs_[topic_ind].filtercfg_min_vreloncome);
        initializeConfig<float>(radar_name, std::string("filtercfg_max_vreloncome"), 128.0, radar_filter_configs_[topic_ind].filtercfg_max_vreloncome);

        // Initialize Departing Velocity Filters
        initializeConfig<float>(radar_name, std::string("filtercfg_min_vreldepart"), 0.0, radar_filter_configs_[topic_ind].filtercfg_min_vreldepart);
        initializeConfig<float>(radar_name, std::string("filtercfg_max_vreldepart"), 128.0, radar_filter_configs_[topic_ind].filtercfg_max_vreldepart);

        // Initialize Radar Cross Section Filters
        initializeConfig<float>(radar_name, std::string("filtercfg_min_rcs"), 0.0, radar_filter_configs_[topic_ind].filtercfg_min_rcs);
        initializeConfig<float>(radar_name, std::string("filtercfg_max_rcs"), 100.0, radar_filter_configs_[topic_ind].filtercfg_max_rcs);

        // Initialize Lifetime Filters
        initializeConfig<float>(radar_name, std::string("filtercfg_min_lifetime"), 0.0, radar_filter_configs_[topic_ind].filtercfg_min_lifetime);
        initializeConfig<float>(radar_name, std::string("filtercfg_max_lifetime"), 409.0, radar_filter_configs_[topic_ind].filtercfg_max_lifetime);

        // Initialize Size Filters
        initializeConfig<float>(radar_name, std::string("filtercfg_min_size"), 0.0, radar_filter_configs_[topic_ind].filtercfg_min_size);
        initializeConfig<float>(radar_name, std::string("filtercfg_max_size"), 102.0, radar_filter_configs_[topic_ind].filtercfg_max_size);

        // Initialize Probability of Existence Filters
        initializeConfig<uint8_t>(radar_name, std::string("filtercfg_min_probexists"), 0, radar_filter_configs_[topic_ind].filtercfg_min_probexists);
        initializeConfig<uint8_t>(radar_name, std::string("filtercfg_max_probexists"), 7, radar_filter_configs_[topic_ind].filtercfg_max_probexists);

        // Initialize Y Filters
        initializeConfig<float>(radar_name, std::string("filtercfg_min_y"), 0.0, radar_filter_configs_[topic_ind].filtercfg_min_y);
        initializeConfig<float>(radar_name, std::string("filtercfg_max_y"), 818.0, radar_filter_configs_[topic_ind].filtercfg_max_y);

        // Initialize X Filters
        initializeConfig<float>(radar_name, std::string("filtercfg_min_x"), 0.0, radar_filter_configs_[topic_ind].filtercfg_min_x);
        initializeConfig<float>(radar_name, std::string("filtercfg_max_x"), 0.0, radar_filter_configs_[topic_ind].filtercfg_max_x);

        // Initialize Y Velocity going left to right Filters
        initializeConfig<float>(radar_name, std::string("filtercfg_min_vyrightleft"), 0.0, radar_filter_configs_[topic_ind].filtercfg_min_vyrightleft);
        initializeConfig<float>(radar_name, std::string("filtercfg_max_vyrightleft"), 128.0, radar_filter_configs_[topic_ind].filtercfg_max_vyrightleft);

        // Initialize X Velocity oncoming Filters
        initializeConfig<float>(radar_name, std::string("filtercfg_min_vxoncome"), 0.0, radar_filter_configs_[topic_ind].filtercfg_min_vxoncome);
        initializeConfig<float>(radar_name, std::string("filtercfg_max_vxoncome"), 128.0, radar_filter_configs_[topic_ind].filtercfg_max_vxoncome);

        // Initialize Y Velocity going right to left Filters
        initializeConfig<float>(radar_name, std::string("filtercfg_min_vyleftright"), 0.0, radar_filter_configs_[topic_ind].filtercfg_min_vyleftright);
        initializeConfig<float>(radar_name, std::string("filtercfg_max_vyleftright"), 128.0, radar_filter_configs_[topic_ind].filtercfg_max_vyleftright);

        // Initialize X Velocity Departing Filters
        initializeConfig<float>(radar_name, std::string("filtercfg_min_vxdepart"), 0.0, radar_filter_configs_[topic_ind].filtercfg_min_vxdepart);
        initializeConfig<float>(radar_name, std::string("filtercfg_max_vxdepart"), 128.0, radar_filter_configs_[topic_ind].filtercfg_max_vxdepart);
    ...
    for (int radar_index = 0; radar_index < radar_filter_configs_.size(); radar_index++)
    {
      for (int filter_index = 0; filter_index < MAX_FilterState_Cfg_FilterState_Index; filter_index++)
      {
        ...
        case FilterType::NOFOBJ:
          min_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_min_nofobj);
          max_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_max_nofobj);
          break;
        case FilterType::DISTANCE:
          min_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_min_distance / 0.1);
          max_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_max_distance / 0.1);
          break;
        case FilterType::AZIMUTH:
          min_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_min_azimuth / 0.025);
          max_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_max_azimuth / 0.025);
          break;
        case FilterType::VRELONCOME:
          min_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_min_vreloncome / 0.0315);
          max_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_max_vreloncome / 0.0315);
          break;
        case FilterType::VRELDEPART:
          min_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_min_vreldepart / 0.0315);
          max_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_max_vreldepart / 0.0315);
          break;
        case FilterType::RCS:
          min_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_min_rcs / 0.025);
          max_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_max_rcs / 0.025);
          break;
        case FilterType::LIFETIME:
          min_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_min_lifetime / 0.1);
          max_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_max_lifetime / 0.1);
          break;
        case FilterType::SIZE:
          min_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_min_size / 0.025);
          max_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_max_size / 0.025);
          break;
        case FilterType::PROBEXISTS:
          min_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_min_probexists);
          max_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_max_probexists);
          break;
        case FilterType::Y:
          min_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_min_y / 0.2);
          max_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_max_y / 0.2);
          break;
        case FilterType::X:
          min_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_min_x);
          max_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_max_x);
          break;
        case FilterType::VYRIGHTLEFT:
          min_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_min_vyrightleft / 0.0315);
          max_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_max_vyrightleft / 0.0315);
          break;
        case FilterType::VXONCOME:
          min_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_min_vxoncome / 0.0315);
          max_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_max_vxoncome / 0.0315);
          break;
        case FilterType::VYLEFTRIGHT:
          min_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_min_vyleftright / 0.0315);
          max_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_max_vyleftright / 0.0315);
          break;
        case FilterType::VXDEPART:
          min_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_min_vxdepart / 0.0315);
          max_value = static_cast<int>(radar_filter_configs_[radar_index].filtercfg_max_vxdepart / 0.0315);
          break;
        default:
          break;
        }
  ...
  void radar_conti_ars408::updateFilterConfig(std::shared_ptr<const polymath::socketcan::CanFrame> frame, const int &sensor_id)
  {
    ...
    radar_filter_configs_[sensor_id].filtercfg_type = CALC_FilterState_Cfg_FilterState_Type(GET_FilterState_Cfg_FilterState_Type(frame->get_data()), 1.0);
    int index = CALC_FilterState_Cfg_FilterState_Index(GET_FilterState_Cfg_FilterState_Index(frame->get_data()), 1.0);

    switch (filterTypes[index])
    {
    case FilterType::NOFOBJ:
      radar_filter_configs_[sensor_id].filtercfg_min_nofobj = CALC_FilterState_Cfg_FilterState_Min_NofObj(
          GET_FilterState_Cfg_FilterState_Min_NofObj(frame->get_data()), 1.0);
      radar_filter_configs_[sensor_id].filtercfg_max_nofobj = CALC_FilterState_Cfg_FilterState_Max_NofObj(
          GET_FilterState_Cfg_FilterState_Max_NofObj(frame->get_data()), 1.0);
      break;
    case FilterType::DISTANCE:
      radar_filter_configs_[sensor_id].filtercfg_min_distance = CALC_FilterState_Cfg_FilterState_Min_Distance(
          GET_FilterState_Cfg_FilterState_Min_Distance(frame->get_data()), 1.0);
      radar_filter_configs_[sensor_id].filtercfg_max_distance = CALC_FilterState_Cfg_FilterState_Max_Distance(
          GET_FilterState_Cfg_FilterState_Max_Distance(frame->get_data()), 1.0);
      break;
    case FilterType::AZIMUTH:
      radar_filter_configs_[sensor_id].filtercfg_min_azimuth = CALC_FilterState_Cfg_FilterState_Min_Azimuth(
          GET_FilterState_Cfg_FilterState_Min_Azimuth(frame->get_data()), 1.0);
      radar_filter_configs_[sensor_id].filtercfg_max_azimuth = CALC_FilterState_Cfg_FilterState_Max_Azimuth(
          GET_FilterState_Cfg_FilterState_Max_Azimuth(frame->get_data()), 1.0);
      break;
    case FilterType::VRELONCOME:
      radar_filter_configs_[sensor_id].filtercfg_min_vreloncome = CALC_FilterState_Cfg_FilterState_Min_VrelOncome(
          GET_FilterState_Cfg_FilterState_Min_VrelOncome(frame->get_data()), 1.0);
      radar_filter_configs_[sensor_id].filtercfg_max_vreloncome = CALC_FilterState_Cfg_FilterState_Max_VrelOncome(
          GET_FilterState_Cfg_FilterState_Max_VrelOncome(frame->get_data()), 1.0);
      break;
    case FilterType::VRELDEPART:
      radar_filter_configs_[sensor_id].filtercfg_min_vreldepart = CALC_FilterState_Cfg_FilterState_Min_VrelDepart(
          GET_FilterState_Cfg_FilterState_Min_VrelDepart(frame->get_data()), 1.0);
      radar_filter_configs_[sensor_id].filtercfg_max_vreldepart = CALC_FilterState_Cfg_FilterState_Max_VrelDepart(
          GET_FilterState_Cfg_FilterState_Max_VrelDepart(frame->get_data()), 1.0);
      break;
    case FilterType::RCS:
      radar_filter_configs_[sensor_id].filtercfg_min_rcs = CALC_FilterState_Cfg_FilterState_Min_RCS(
          GET_FilterState_Cfg_FilterState_Min_RCS(frame->get_data()), 1.0);
      radar_filter_configs_[sensor_id].filtercfg_max_rcs = CALC_FilterState_Cfg_FilterState_Max_RCS(
          GET_FilterState_Cfg_FilterState_Max_RCS(frame->get_data()), 1.0);
      break;
    case FilterType::LIFETIME:
      radar_filter_configs_[sensor_id].filtercfg_min_lifetime = CALC_FilterState_Cfg_FilterState_Min_Lifetime(
          GET_FilterState_Cfg_FilterState_Min_Lifetime(frame->get_data()), 1.0);
      radar_filter_configs_[sensor_id].filtercfg_max_lifetime = CALC_FilterState_Cfg_FilterState_Max_Lifetime(
          GET_FilterState_Cfg_FilterState_Max_Lifetime(frame->get_data()), 1.0);
      break;
    case FilterType::SIZE:
      radar_filter_configs_[sensor_id].filtercfg_min_size = CALC_FilterState_Cfg_FilterState_Min_Size(
          GET_FilterState_Cfg_FilterState_Min_Size(frame->get_data()), 1.0);
      radar_filter_configs_[sensor_id].filtercfg_max_size = CALC_FilterState_Cfg_FilterState_Max_Size(
          GET_FilterState_Cfg_FilterState_Max_Size(frame->get_data()), 1.0);
      break;
    case FilterType::PROBEXISTS:
      radar_filter_configs_[sensor_id].filtercfg_min_probexists = CALC_FilterState_Cfg_FilterState_Min_ProbExists(
          GET_FilterState_Cfg_FilterState_Min_ProbExists(frame->get_data()), 1.0);
      radar_filter_configs_[sensor_id].filtercfg_max_probexists = CALC_FilterState_Cfg_FilterState_Max_ProbExists(
          GET_FilterState_Cfg_FilterState_Max_ProbExists(frame->get_data()), 1.0);
      break;
    case FilterType::Y:
      radar_filter_configs_[sensor_id].filtercfg_min_y = CALC_FilterState_Cfg_FilterState_Min_Y(
          GET_FilterState_Cfg_FilterState_Min_Y(frame->get_data()), 1.0);
      radar_filter_configs_[sensor_id].filtercfg_max_y = CALC_FilterState_Cfg_FilterState_Max_Y(
          GET_FilterState_Cfg_FilterState_Max_Y(frame->get_data()), 1.0);
      break;
    case FilterType::X:
      radar_filter_configs_[sensor_id].filtercfg_min_x = CALC_FilterState_Cfg_FilterState_Min_X(
          GET_FilterState_Cfg_FilterState_Min_X(frame->get_data()), 1.0);
      radar_filter_configs_[sensor_id].filtercfg_max_x = CALC_FilterState_Cfg_FilterState_Max_X(
          GET_FilterState_Cfg_FilterState_Max_X(frame->get_data()), 1.0);
      break;
    case FilterType::VYRIGHTLEFT:
      radar_filter_configs_[sensor_id].filtercfg_min_vyrightleft = CALC_FilterState_Cfg_FilterState_Min_VYRightLeft(
          GET_FilterState_Cfg_FilterState_Min_VYRightLeft(frame->get_data()), 1.0);
      radar_filter_configs_[sensor_id].filtercfg_max_vyrightleft = CALC_FilterState_Cfg_FilterState_Max_VYRightLeft(
          GET_FilterState_Cfg_FilterState_Max_VYRightLeft(frame->get_data()), 1.0);
      break;
    case FilterType::VXONCOME:
      radar_filter_configs_[sensor_id].filtercfg_min_vxoncome = CALC_FilterState_Cfg_FilterState_Min_VXOncome(
          GET_FilterState_Cfg_FilterState_Min_VXOncome(frame->get_data()), 1.0);
      radar_filter_configs_[sensor_id].filtercfg_max_vxoncome = CALC_FilterState_Cfg_FilterState_Max_VXOncome(
          GET_FilterState_Cfg_FilterState_Max_VXOncome(frame->get_data()), 1.0);
      break;
    case FilterType::VYLEFTRIGHT:
      radar_filter_configs_[sensor_id].filtercfg_min_vyleftright = CALC_FilterState_Cfg_FilterState_Min_VYLeftRight(
          GET_FilterState_Cfg_FilterState_Min_VYLeftRight(frame->get_data()), 1.0);
      radar_filter_configs_[sensor_id].filtercfg_max_vyleftright = CALC_FilterState_Cfg_FilterState_Max_VYLeftRight(
          GET_FilterState_Cfg_FilterState_Max_VYLeftRight(frame->get_data()), 1.0);
      break;
    case FilterType::VXDEPART:
      radar_filter_configs_[sensor_id].filtercfg_min_vxdepart = CALC_FilterState_Cfg_FilterState_Min_VXDepart(
          GET_FilterState_Cfg_FilterState_Min_VXDepart(frame->get_data()), 1.0);
      radar_filter_configs_[sensor_id].filtercfg_max_vxdepart = CALC_FilterState_Cfg_FilterState_Max_VXDepart(
